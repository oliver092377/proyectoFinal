...
function showWelcome(){
  let html = '<h1>Bienvenido ' + userFullName + '</h1>\n';
  html += `
          <p>Este stema fue desarrollado por alumnos del primer año de la Escuela Profesional de Ingeniería de Sistemas, de la Universidad Nacional de San Agustín de Arequipa</p>
